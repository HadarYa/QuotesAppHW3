...
public class QuotesIntentService extends IntentService {
    ...
    public static final String NOTIFY = "com.quatesapphw3.notify";
    ...
    /**********************************************************************
     Run the receiver class and use AlarmManger in order to pop
    ...
    private void handleActionNotify() throws PendingIntent.CanceledException {
        ...
        Intent intent = new Intent(this, QuotesReceiver.class);
